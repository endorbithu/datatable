...
Datatable.js integráció Laravel-hez.
...
php artisan vendor:publish
 Which provider or tag's files would you like to publish?:
  ...
  [1 ] Provider: Datatable\Providers\DatatableServiceProvider
```
...
akkor ha a XHR action-ben le van kezelve, háttérben fog a csv generálódni (`\Datatable\Jobs\ProcessBigCsvExportToFile`)     
```
